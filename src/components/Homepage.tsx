...
const Homepage: React.FC<HomepageProps> = ({ onSearch, onNavigate }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <div className="mx-auto max-w-2xl text-center">
              ...
              <form onSubmit={handleSearch} className="w-full max-w-md">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="flex h-12 w-full rounded-md border border-neutral-200 bg-white pl-10 pr-24 text-sm ring-offset-white file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-neutral-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-yellow-600 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 dark:border-neutral-800 dark:bg-neutral-950 dark:ring-offset-neutral-950 dark:placeholder:text-neutral-400 dark:focus-visible:ring-yellow-400"
                  />
                  <button
                    type="submit"
                    className="absolute right-1 top-1/2 -translate-y-1/2 inline-flex items-center justify-center rounded-md bg-yellow-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-yellow-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-yellow-600 focus-visible:ring-offset-2 dark:bg-yellow-600 dark:hover:bg-yellow-700"
                  >
                    Buscar
                  </button>
                </div>
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <button
                ...
                className="rounded-md bg-yellow-600 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-yellow-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-yellow-600 dark:bg-yellow-600 dark:hover:bg-yellow-700"
              >
                Explorar Catálogo
              </button>
              <button
                onClick={() => onNavigate?.('calculator')}
                className="text-sm font-semibold leading-6 text-neutral-900 dark:text-white hover:text-yellow-600 dark:hover:text-yellow-400 flex items-center"
              >
      ...
      {/* CTA Section */}
      <section className="bg-yellow-600 dark:bg-yellow-700">
        <div className="container mx-auto px-4 py-24 sm:py-32">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <button
                onClick={() => onNavigate?.('catalog')}
                className="rounded-md bg-white px-6 py-3 text-sm font-semibold text-yellow-600 shadow-sm hover:bg-neutral-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
              >
                Explorar Catálogo
              </button>
              <button
                onClick={() => onNavigate?.('calculator')}
                className="text-sm font-semibold leading-6 text-white hover:text-yellow-100 flex items-center"
              >
                Calcular Costos <ChevronRight className="ml-1 h-4 w-4" />
              </button>
            </div>
